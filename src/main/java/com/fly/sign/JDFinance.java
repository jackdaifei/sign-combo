...
public class JDFinance {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String cookie2 = "__jdv=168871293|direct|-|none|-|1562295302567; _jrda=1; __jrr=845DAE3537D8571FAD5F372CCBC4FC; __jda=9201833.1562295302565511567946.1562295303.1562295303.1562295303.1; __jdb=9201833.2.1562295302565511567946|1.1562295303; __jdc=9201833; _jrdb=1562295314609; __jdu=1562295302565511567946; pt_key=app_openAAJdHrwGADDnYgT_5lZ2KWt4Acle5UhtS8ylN8wcFVthNZjheGC0SWPSc96bkgeR4IKyIgJVvfY; pt_pin=jackdaifei_m; pwdt_id=jackdaifei_m; sid=18121c2d903e37429a54bb6934640bcw; 3AB9D23F7A4B3C9B=KWVSHNUO4MB3VTPWRM3MFPRQVSARY54O3KPOQT5W66NHNZBHJDDRC4HGJ62D6KPCDVIVY2DNZNQTJCE5IWRW5GJFYE; qd_ad=-%7C-%7Cdirect%7C-%7C0; qd_sid=JXPIAB4G-ADPQ2TNWCWRO2WF534QT-1; qd_uid=JXPIAB4G-ADPQ2TNWCWRO2WF534QT; qd_sq=1; qd_fs=1562295303370; qd_ls=1562295303370; qd_ts=1562295303370";
        ...
        while (true) {
            harvest(jhCookie);
            int sleepNum = CommonUtils.randomNum(180154, 688431);
        ...
        if (null != dataJson) {
            ...
            if (resultCode == 0) {
                ...
                for (int i=0;i<bannerList.size();i++) {
                    ...
                    sendAdGb(cookie, banner.getString("adId"));
    ...
    private static void sendAdGb(String cookie, String adId) throws Exception {
